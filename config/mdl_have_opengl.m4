...
dnl URL accordingly.
dnl
dnl @version 0.03 $Id: mdl_have_opengl.m4,v 1.1 2005/08/15 00:33:24 andreaskohn Exp $
dnl @author Matthew D. Langston <langston@SLAC.Stanford.EDU>


dnl Andreas Kohn <andreas@syndrom23.de>
dnl   use_Mesa default changed to no
dnl   modified the AC_ARG_ENABLE part to work with newer autoconf versions 
dnl   removed glut 
...
dnl Check for Mesa first, unless we were asked not to.
    AC_ARG_ENABLE(
    	Mesa, 
	AC_HELP_STRING([--with-Mesa],[Prefer the Mesa library over a vendors native OpenGL library (default=no)]),
	use_Mesa=$enableval, 
	use_Mesa=no)
